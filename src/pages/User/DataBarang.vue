<template>
  <q-page>
    <q-card
      ...
      <div class="row">
        <div class="col-4">
          <q-img
            class="q-pa-sm"
            :src="`http://localhost:3000/${barang.image}`"
        ...
        <div class="col q-pa-sm">
          <div class="column">
            ...
            <div class="row q-pt-xl">
              <div class="text-h5 q-mt-md text-red">Rp. {{ barang.hargabarang }} </div>
              <q-space/>
              <q-input v-model="jumlah[index]" class="text-h5 q-pl-xl" style="width: 120px;" type="number"/>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="column absolute-bottom q-pa-md">
