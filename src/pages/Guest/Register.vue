    ...
    <div class="row q-pt-xl flex flex-center">
      ...
      <div class="col-sm-12 col-xs-12 col-md-5 q-pa-md">
        <q-card class="q-pa-md" style="border-radius: 10px">
          <p class="title text-center" style="color: #4C4C4C; font-size: 30px; margin-top: -10px">Daftar</p>
          <p class="subtitle text-center" style="color: #C1C8BC; margin-top: -20px">Sudah Punya akun Tani App? <q-btn flat no-caps dense :to="{name: 'login'}" class="text-blue" color="primary" label="Login Disini"/> </p>
          <q-form
            class="q-gutter-md">
            <q-input
              filled
